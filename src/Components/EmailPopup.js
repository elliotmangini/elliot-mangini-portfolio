      ...
      <>
        <div className={style.email_popup_container} >
          <form id={style.form_container} ref={form} onSubmit={sendEmail}>
            <label>Name</label>
            <input id={style.name_input} contenteditable="true" spellcheck="false" type="text" name="user_name" placeholder='name' onChange={(e) => setName(e.target.value)} value={name}/>
            <br />
            <label>Email</label>
            <input id={style.email_input} contenteditable="true" spellcheck="false" type="email" name="user_email" placeholder='e-mail' onChange={(e) => setEmail(e.target.value)} value={email}/>
            <br />
            <label>Message</label>
            <textarea id={style.message_input} contenteditable="true" spellcheck="false" name="message" placeholder='message...' onChange={(e) => setMessage(e.target.value)} value={message}/>
            <br />
